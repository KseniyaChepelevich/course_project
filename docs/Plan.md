...
### 8. Отправка заполненной формы с пустым полем "CVC". Карта APPROVED.
    ...
    Шаги: 
        ...
        2. В поле "Месяц" ввести валидное значение.
        3. В поле "Год" ввести валидное значение.
        4. В поле "Владелец"  ввести валдиное значение
...
### 12. Отправка заполненной формы. В поле "Владелец" ввести имя на кириллице. Карта APPROVED.
    ...
    Шаги:
      ...
      6. Нажать кнопку "Продолжить".
    Ожидаемый результат:
      1. Поле "Владелец" подчеркивается красным. Под полем появляется сообщение "Неверный формат"
      2. Форма не отправляется, в базе данных записей о данной попытке не появляется.
...
### 32 Отправка заполненной формы. В поле "Год" ввести прошедший год. Карта APPROVED.
    ...
    Шаги: 
        ...
        6. Нажать кнопку "Продолжить".
     Ожидаемый результат: 
        1. Поле "Год" подчеркивается красным. Под полем появляется сообщение "Истёк срок действия карты".
        2. Форма не отправляется, в базе данных записей о данной попытке не появляется.
...
### 36. Отправка заполненной формы. В поле "Год" ввести год через 6 лет. Карта APPROVED.
    ...
    Шаги: 
        ...
        3. В поле "Год" ввести год через 6 лет (например "28").
        4. В поле "Владелец" ввести валидное значение.
        5. В поле "CVC" ввести валидное значение.
        6. Нажать кнопку "Продолжить".
     Ожидаемый результат: 
...
### 37. Отправка заполненной формы. В поле "Год" ввести год через 5 лет. Карта APPROVED.
    ...
    Шаги: 
        1. В поле "Номер карты" ввести валидное значение.
        2. В поле "Месяц" ввести текущий месяц.
        3. В поле "Год" ввести год через 5 лет (например "27").
        4. В поле "Владелец" ввести валидное значение.
        5. В поле "CVC" ввести валидное значение.
        6. Нажать кнопку "Продолжить".
     Ожидаемый результат: 
...
### 38. Отправка заполненной формы. В поле "Год" ввести год через 4 года. Карта APPROVED.
    ...
    Шаги: 
        1. В поле "Номер карты" ввести валидное значение.
        2. В поле "Месяц" ввести текущий месяц.
        3. В поле "Год" ввести год через 4 лет (например "26").
        4. В поле "Владелец" ввести валидное значение.
        5. В поле "CVC" ввести валидное значение.
        6. Нажать кнопку "Продолжить".
     Ожидаемый результат: 
...
### 39. Отправка заполненной формы. В поле "Год" ввести нецифровые и небуквенные символы. Карта APPROVED.
    ...
    Шаги: 
        1. В поле "Номер карты" ввести валидное значение.
        2. В поле "Месяц" ввести валидное значение.
        3. В поле "Год" ввести нецифровые и небуквенные символы (например "*/").
            Ожидаемый результат: знаки не отобразятся, поле останется пустым.
        4. В поле "Владелец" ввести валидное значение.
        5. В поле "CVC" ввести валидное значение.
        6. Нажать кнопку "Продолжить".
...
### 40. Отправка заполненной формы. В поле "Год" ввести буквенные символы. Карта APPROVED.
    ...
    Шаги: 
        1. В поле "Номер карты" ввести валидное значение.
        2. В поле "Месяц" ввести валидное значение.
        3. В поле "Год" ввести буквенные символы (например "ab").
            Ожидаемый результат: знаки не отобразятся, поле останется пустым.
        4. В поле "Владелец" ввести валидное значение.
        5. В поле "CVC" ввести валидное значение.
        6. Нажать кнопку "Продолжить".
...
## Перечень и описание возможных рисков при автоматизации
    ...
    8. Если будет баг в банковском сервисе, то тесты будут падать.
